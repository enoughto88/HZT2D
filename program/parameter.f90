...
module parameters_mod
   ...
   !Grid parameter
   integer         ,parameter  :: NXMAX     = 24                        ![-] x number of cells
   integer         ,parameter  :: NYMAX     = 24                        ![-] y number of cells
   ...
   double precision,parameter  :: DXL       = XL/dble(NXMAX)            ![m] Cell length in x-direction
   double precision,parameter  :: DYL       = YL/dble(NYMAX)            ![m] Cell length in y-direction
   !Particle parameter
   integer         ,parameter  :: NPMAX     = 8000000                   ![-] Maximum number of particles
